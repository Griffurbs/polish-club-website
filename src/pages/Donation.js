...
function DonationPage() {
    return (
        <Container>
            <Row>
                <p>Please consider donating to the Polish Club at UT. Any donation is greatly appreciated. Thank you very much for your support and generosity.</p>
                <br/><br/>
                <h3>Why donate?</h3>
                <p>With the funds we receive, we will purchase club t-shirts, cater Polish food for our events, help cover travel costs to Polish-related sites, pay for ingredients for cooking sessions, and cover general administrative fees.</p>
                <br/><br/>
                <h3>How to donate:</h3>
